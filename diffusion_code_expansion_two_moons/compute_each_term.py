...
from main_two_moons import two_moons_data
...
def parse_args():
    ...
    parser.add_argument(
        "--model",
        type=Path,
        default=EXPERIMENT_DIR / "two_moons_backward_process.pt",
        help="Path to the saved backward-process state dict.",
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=EXPERIMENT_DIR / "two_moons_bound_terms_by_lambda.csv",
